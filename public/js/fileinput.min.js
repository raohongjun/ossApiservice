...
!function (e) {
    ...
    var i = function (e) {
            ...
            data: {}, init: function (e) {
                ...
                var r, l, o = "init_" + a, s = t.data[i], d = s.config[a], c = s.initId + "-" + o,
        ...
        U = {
            ...
            actionDelete: C,
            actionUpload: y
        }, j = {generic: T, html: E, image: k, text: F, video: $, audio: I, flash: D, object: P, other: S},
    ...
    _.prototype = {
        constructor: _, validate: function () {
            ...
            var r, l, s, d, c, p, u, f, v, h = this, m = h.getFileStack().length, g = new FormData,
                w = h.previewInitId + "-" + i, b = e("#" + w + ":not(.file-preview-initial)"),
                x = b.find(".kv-file-upload"), C = b.find(".kv-file-remove"),
                y = h.filestack.length > 0 || !e.isEmptyObject(h.uploadExtraData), T = {id: w, index: i};
            ...
            var i, t, a, n, r, l = this, s = l.filestack, d = s.length,
                c = l.filestack.length > 0 || !e.isEmptyObject(l.uploadExtraData), p = {};
            ...
            if (this.showPreview) {
                var n = this, r = W.createObjectURL(i), l = (e("#" + t), n.previewSettings.other || L.other),
                    o = n.renderFileFooter(i.name, l.width), s = n.getPreviewTemplate("other"),
                    d = t.slice(t.lastIndexOf("-") + 1), c = "";
            ...
            if (this.showPreview) {
                var r, l, o, s, d = this, c = d.parseFileType(i), p = d.slug(i.name), u = d.allowedPreviewTypes,
                    f = d.allowedPreviewMimeTypes, v = d.getPreviewTemplate(c),
                    h = M(c, d.previewSettings) ? d.previewSettings[c] : L[c], m = parseInt(d.wrapTextLength, 10),
                    g = d.wrapIndicator, w = u.indexOf(c) >= 0, b = R(f) || !R(f) && -1 !== f.indexOf(i.type),
                    x = d.renderFileFooter(p, h.width), C = "", y = a.slice(a.lastIndexOf("-") + 1);
            ...
            function t(e) {
                ...
                var m, g, w, b, x, C, y = v + e, T = p + "-" + y, E = i[e], k = a.slug(E.name), F = (E.size || 0) / 1e3,
                    $ = "", I = W.createObjectURL(E), D = 0, P = a.allowedFileTypes, S = R(P) ? "" : P.join(", "),
